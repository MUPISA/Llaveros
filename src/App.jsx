...
function App() {
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      title: "Museo Sonoro MUPISA",
      text: `¡Mira lo que descubrí en el Museo Sonoro! Consigue tu llavero NFC para vivir la experiencia.`,
      url: "https://tudominio.com", // Enlace a la tienda o info del museo, no a la canción directa
    };
  ...
  if (!collection) {
    return (
      <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">MUSEO SONORO</h1>
        ...
        <div className="space-y-3 w-full max-w-xs">
          <div className="p-4 bg-white rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4 text-left">
            ...
            <div>
              <p className="text-xs font-bold text-gray-900">¿No sucede nada?</p>
              <p className="text-[10px] text-gray-400">Asegúrate de tener el NFC activado en los ajustes de tu móvil.</p>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center py-12 px-4">
      ...
      <div className="mb-12 flex items-center gap-2">
        ...
        <span className="font-bold text-xl tracking-tight text-gray-900">MUPISA MUSEO SONORO</span>
      </div>
      ...
      <div className="mt-12 w-full max-w-md space-y-4">
        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest text-center mb-6">Escuchar colección completa</h3>
      ...
      <footer className="mt-auto pt-16 pb-8 text-gray-400 text-sm text-center">
        ...
        <p>
          Hecho por <a className='hover:font-bold' href="https://museortizmedia.github.io/" target="_blank" rel="noopener noreferrer">Muse Ortiz Media</a>
        </p>
      </footer>
    </div>
  );
